...
//---------------------------------------------------------------------------
     setConfig(config) {
        ...
        style.textContent = `
            ...
            .iC3inializationRecd {color: dodgerblue;}
            .errorMsg    {color: red;}
            .updateRecd  {color: blue;}
        ...
        if (logAttr.length != 0) {
            ...
            for (i = 0; i < logEntries.length-1; i++) {
                ...
                if (thisRecdTestChg !== nextRecdTestChg) {
                    ...
                    classState    += ' darkred'
                    classZone     += ' darkred'
                    classInterval += ' darkred'
                    classTravTime += ' darkred'
                    classDistance += ' darkred'
                }
        ...
        */
        ...
        if (buttonPressId == "btnRefresh") {
            ...
            if (eltInfoUpdateTime.innerText !== 'setup') {
                ...
                lastButtonPressed.classList.remove('btnClassPressed')
            }
        ...
        thisButtonPressed.classList.add('btnClassPressed')
...
//---------------------------------------------------------------------------
    _clearbtnRefresh() {
        ...
        btnRefresh.classList.remove('btnClassPressed')
    }
//---------------------------------------------------------------------------
    _btnClassMouseOver(buttonId) {
        const root   = this.shadowRoot;
        const button = root.getElementById(buttonId)
        button.classList.add('btnClassMouseOver')
    }
//---------------------------------------------------------------------------
    _btnClassMouseOut(buttonId) {
        ...
        if (button) {
            if (eltInfoUpdateTime !== "setup") {
                button.classList.remove('btnClassMouseOver')
