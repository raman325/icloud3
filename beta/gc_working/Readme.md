...
**group**  
The name of the group of devices being tracked for this username/base_zone.   
*Default:*  username+base_zone parameter    (*Note:* base_zone defaults to 'home')
...
*Note:* When the accuracy is poor, a message is displayed in the `info` attribute field.
