...
- If no iCloud accounts are found when iCloud3 is started, an error message is displayed in the log file.  Displaying this error message generated another error message that is now fixed.
